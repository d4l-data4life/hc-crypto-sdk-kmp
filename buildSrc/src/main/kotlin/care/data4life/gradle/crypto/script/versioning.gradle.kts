 ...
 * }
 *
 * Now just add id("care.data4life.gradle.crypto.script.versioning") to your rootProject build.gradle.kts plugins
 *
 * plugins {
 *     id("care.data4life.gradle.crypto.script.versioning")
 * }
 *
 * Usage:
 *
