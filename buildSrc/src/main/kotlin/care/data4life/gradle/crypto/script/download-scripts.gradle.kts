 ...
 *
 * Now just add id("care.data4life.gradle.crypto.script.download-scripts") to your project module build.gradle.kts plugins section
 *
 * plugins {
...
val scriptPathTarget = "buildSrc/src/main/kotlin/care/data4life/gradle/crypto/script"
