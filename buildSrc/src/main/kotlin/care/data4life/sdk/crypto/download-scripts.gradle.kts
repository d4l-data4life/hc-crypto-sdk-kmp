 ...
 *
 * Now just add id("care.data4life.sdk.crypto.download-scripts") to your project module build.gradle.kts plugins section
 *
 * plugins {
 *     id("care.data4life.sdk.crypto.download-scripts")
 * }
 *
 * Usage:
...
val scriptPathTarget = "buildSrc/src/main/kotlin/care/data4life/sdk/crypto"
