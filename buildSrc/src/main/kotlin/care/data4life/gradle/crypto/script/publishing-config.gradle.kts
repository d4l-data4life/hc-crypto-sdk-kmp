 ...
 * Install:
 *
 * Just add id("care.data4life.gradle.crypto.script.publishing-config") to your project module build.gradle.kts plugins section
 *
 * plugins {
 ...
 *
 * This requires a care.data4life.gradle.crypto.config.LibraryConfig configured
 */
plugins {
    `maven-publish`
}
