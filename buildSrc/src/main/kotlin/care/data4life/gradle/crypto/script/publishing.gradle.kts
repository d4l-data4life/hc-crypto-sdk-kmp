 ...
 * }
 *
 * Now just add id("care.data4life.gradle.crypto.script.publishing") to your rootProject build.gradle.kts plugins
 *
 * plugins {
 *     id("care.data4life.gradle.crypto.script.publishing")
 * }
 *
 * Usage:
 *
