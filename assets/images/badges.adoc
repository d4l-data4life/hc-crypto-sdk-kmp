...
:link-badge-release: https://img.shields.io/badge/Release-1.13.2-blueviolet.svg
...
:link-badge-crypto-support: https://img.shields.io/badge/D4L%20Crypto-v1-orange.svg
Platform image:{link-badge-crypto-support}[D4L Crypto]::
`curl {link-badge-crypto-support} -s -o badge-crypto-support.svg`
