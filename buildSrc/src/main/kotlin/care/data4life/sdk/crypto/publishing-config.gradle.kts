 ...
 * Install:
 *
 * Just add id("care.data4life.sdk.crypto.publishing-config") to your project module build.gradle.kts plugins section
 *
 * plugins {
 ...
 *
 * This requires a care.data4life.sdk.crypto.LibraryConfig configured
 */
plugins {
    `maven-publish`
}
