...
object LibraryConfig {
    ...
    const val group = "care.data4life.sdk.crypto"
    const val name = "hc-crypto-sdk-kmp"

    const val githubOwner = "d4l-data4life"
    const val githubRepository = "hc-crypto-sdk-kmp"

    object PublishConfig {
        const val groupId = "care.data4life.hc-crypto-sdk-kmp"

        const val description = "Implementation of the D4L Crypto Protocol"
        const val year = "2021"
    ...
    object AndroidLibraryConfig {
        ...
        const val resourcePrefix = "hc_crypto_"
    }
}
